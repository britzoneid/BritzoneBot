...
class MessageService {
   ...
   */
  async broadcastToBreakoutRooms(guildId: string, message: string): Promise<BroadcastResult> {
   ...
   */
  async sendMessageToChannel(channel: VoiceChannel, message: string): Promise<ChannelMessageResult> {
